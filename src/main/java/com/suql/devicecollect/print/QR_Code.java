...
public class QR_Code {
            ...
            try {
                ...
                for (int i = 0; i < desc.length(); i++) {
                    ...
                    if (currentLineLen + charWidth > width) {
                        currentLineIndex++;
                        currentLineLen = 0;
                        g1.drawString(c, currentLineLen + startX + 15,
    ...
    public static void main(String[] args) {
        ...
        info.setContents("SN:0000000001,MAC:FFFFDC2C26123456");
        info.setWidth(150);
        info.setHeight(150);
        info.setFontSize(18);
        info.setLogoFile(null);
        info.setDesc("SN:0000000001");
        info.setDate("");
        info.setLogoFile(null);
        QR_Code code = new QR_Code();
        String realPath = "E:\\personnelManage\\" ;
        code.createCodeImage(info, realPath + imgname);
    }
}
